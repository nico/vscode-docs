...
Next, we need to create a `tasks.json` file to tell VS Code how to build (compile) the program. This task will invoke the clangg++ compiler to create an executable file based on the source code.
